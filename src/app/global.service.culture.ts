    ...
    if (GlobalService.getGlobalSettings().translateStrategy.type == "API") {
      return this.getResource(grupo, culture, infos, (culture: any, infosFields: any) => {
        return new Promise((resolve, reject) => {
          this.api.setResource(GlobalService.getGlobalSettings().translateStrategy.resource).get({ group: grupo })
            .subscribe((result) => {
      ...
      return this.getResource(grupo, culture, infos, (culture: any, infosFields: any) => {
        return new Promise((resolve, reject) => {
          ...
          let v = Math.random();
          this.http.get(GlobalService.getGlobalSettings().translateStrategy.resource + "?v=" + v)
            .toPromise()
            .then((response: any) => {
